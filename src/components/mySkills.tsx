...
function MySkills (){
    return (
        <section className="w-full my-10 flex flex-col py-12">
            ...
            <div className="w-full pl-5 my-10 text-azulOscuro flex flex-col justify-start">
            ...
            <div className="w-full pl-5 my-10 flex flex-col justify-start text-azulOscuro ">
